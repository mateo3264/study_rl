...
from dyn_graph import show_dyn_graph
...
if __name__ == '__main__':
    with open('terminal_rewards.txt', 'w') as f:
        f.write('')
    
    env = MatchingToSample(latency=5, model_steps=1, comparative_steps=1, n_stimuli=10)
    ...
    p1 = Process(target=run_experiment, args=(env, 1, [features], ['sarsa'], 2, 10000))
    p2 = Process(target=show_dyn_graph)
